...
{
    /// <summary>
    /// Ensures property.snapshot exists as a compacted topic before anything publishes to it.
        ...
        this IServiceProvider services, CancellationToken ct = default)
    {
        ...
        await provisioner.EnsureCompactedTopicAsync(Topics.PropertySnapshot, ct: ct);
    }
}
